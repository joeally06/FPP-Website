...
export default function EnhancedVotingCard({
          ...
          <button
            ...
            className={`
              ...
              ${song.hasVoted
                ...
                : 'bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white hover:scale-110 shadow-lg hover:shadow-blue-500/50'
              }
  ...
  return (
    <div className="group relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
      {/* Trending/Hot Badge */}
      {(isHot || isTrending) && (
        <div className="absolute top-3 right-3 z-10">
          {isHot && (
            <div className="flex items-center gap-1 bg-gradient-to-r from-orange-500 to-red-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg animate-pulse">
              🔥 HOT
            </div>
          )}
          {isTrending && !isHot && (
            <div className="flex items-center gap-1 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-3 py-1 rounded-full text-xs font-bold">
              <TrendingUp size={12} />
              Trending
            </div>
          )}
      ...
      {/* Position Badge */}
      {song.position && (
        <div className="absolute -top-3 -left-3 w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center font-bold text-lg shadow-lg z-10">
          #{song.position}
        </div>
      )}
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className={`
            ...
            ${song.hasVoted
              ? 'bg-gradient-to-r from-green-600/30 to-emerald-600/30 text-green-400 cursor-not-allowed border-2 border-green-500/50'
              : 'bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white hover:scale-[1.02] shadow-lg hover:shadow-blue-500/50 active:scale-[0.98]'
            }
            disabled:opacity-50 disabled:cursor-not-allowed
          `}
        >
      ...
      <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 blur-xl" />
      </div>
    </div>
  );
}
