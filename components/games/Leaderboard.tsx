...
export default function Leaderboard({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-gradient-to-br from-red-600 via-green-600 to-blue-600 p-1 rounded-2xl shadow-2xl max-w-2xl w-full my-8">
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border-2 border-yellow-500/50 rounded-lg p-4 text-center">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 border-2 border-blue-500/50 rounded-lg p-4 text-center">
          ...
          <div className="flex gap-3 flex-col sm:flex-row">
            <button
              onClick={onPlayAgain}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg font-bold text-lg transition-all shadow-lg hover:shadow-xl hover:scale-105"
            >
              🎮 Play Again
            </button>
            <button
