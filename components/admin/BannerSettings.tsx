...
const COLOR_PRESETS = [
  ...
  {
    name: 'Purple',
    bgColor: 'bg-gradient-to-r from-purple-600/30 to-purple-700/30',
    textColor: 'text-white',
  ...
  {
    name: 'Green',
    bgColor: 'bg-gradient-to-r from-green-600/30 to-green-700/30',
    textColor: 'text-white',
    borderColor: 'border-green-500/50',
  },
  {
    name: 'Yellow',
    bgColor: 'bg-gradient-to-r from-yellow-600/30 to-yellow-700/30',
    textColor: 'text-white',
  ...
  {
    name: 'Slate',
    bgColor: 'bg-gradient-to-r from-slate-700/30 to-slate-800/30',
    textColor: 'text-white',
    borderColor: 'border-slate-600/50',
  },
  {
    name: 'Christmas',
    bgColor: 'bg-gradient-to-r from-red-600/30 via-green-600/30 to-red-600/30',
    textColor: 'text-white',
    borderColor: 'border-red-500/50',
  },
  {
    name: 'Halloween',
    bgColor: 'bg-gradient-to-r from-orange-600/30 via-purple-600/30 to-orange-600/30',
    textColor: 'text-white',
    borderColor: 'border-orange-500/50',
  },
];
...
export default function BannerSettings() {
  const [config, setConfig] = useState<BannerConfig>({
    ...
    countdownBgColor: 'bg-gradient-to-r from-blue-600/30 to-blue-700/30',
    ...
    offSeasonBgColor: 'bg-gradient-to-r from-purple-600/30 to-purple-700/30',
    ...
    offlineBgColor: 'bg-gradient-to-r from-slate-700/30 to-slate-800/30',
